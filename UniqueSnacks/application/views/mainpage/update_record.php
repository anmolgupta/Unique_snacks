...
<div id="nav-bar">
        <h2>  <u>  Entry Of New Record  </u></h2>
            <form action="/UniqueSnacks/index.php/newEntry/update_callback" name="myForm"  method="post" onsubmit="return(validate());">
                ...
                <table cellpadding="3" cellspacing="2">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="doj" value="<?php echo $record->doj; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="husband_fathername" value="<?php echo $record->husband_fathername; ?>"   />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="dob" value="<?php echo $record->dob; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <select name="sex">
                              ...
                              <option value="Male" <?php echo $record->sex=='Male'?'Selected="Selected"':'' ?> >Male</option>
                              <option value="Female" <?php echo $record->sex=='Female'?'Selected="Selected"':'' ?> >Female</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="place_of_birth" value="<?php echo $record->place_of_birth; ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <select name="marital_status">
                              ...
                              <option value="Single" <?php echo $record->marital_status=='Single'?'Selected="Selected"':'' ?> > Single</option>
                              <option value="Married" <?php echo $record->marital_status=='Married'?'Selected="Selected"':'' ?> > Married</option>
                              <option value="Divorced" <?php echo $record->marital_status=='Divorced'?'Selected="Selected"':'' ?> > Divorced </option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="nationality" value="<?php echo $record->nationality; ?>"  />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="pan_no" value="<?php echo $record->pan_no; ?>"  />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="pincode" value="<?php echo $record->pincode; ?>" />
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="mobile_no" value="<?php echo $record->mobile_no; ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="nominee_name" value="<?php echo $record->nominee_name; ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="relationship_with_nominee" value="<?php echo $record->relationship_with_nominee; ?>"  />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="joining_fee" value="<?php echo $record->joining_fee; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="introducer_id" value="<?php echo $record->introducer_id; ?>"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="account_no" value="<?php echo $record->account_no; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="name_of_bank" value="<?php echo $record->name_of_bank; ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="name_of_branch" value="<?php echo $record->name_of_branch; ?>" />
                        </td>
                    </tr>
